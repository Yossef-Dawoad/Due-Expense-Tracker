...
class _$TransactionCategoryImpl implements _TransactionCategory {
  ...
  @override
  String toString() {
    return 'TransactionCategory(id: $id, title: $title, totalAmount: $totalAmount, color: $color, status: $status, icon: $icon, description: $description)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, title, totalAmount, color, status, icon, description);
...
abstract class _TransactionCategory implements TransactionCategory {
  const factory _TransactionCategory(
      ...
      final String? description}) = _$TransactionCategoryImpl;
